...
images :: Array String
images =  [ "../../img/eevee.png",    "../../img/eevee-shiny.png", 
            "../../img/pikachu.png",  "../../img/pikachu-shiny.png", 
            "../../img/turtwig.png",  "../../img/turtwig-shiny.png",
            "../../img/latios.png",   "../../img/latios-shiny.png",
            "../../img/latias.png",   "../../img/latias-shiny.png"
          ]